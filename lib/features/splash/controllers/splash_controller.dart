...
class SplashController extends GetxController implements GetxService {
  ...
  int? getPaperSize() {
    return splashServiceInterface.getPaperSize();
  }

  Future<void> setPaperSize(int? paperSize) async {
    await splashServiceInterface.setPaperSize(paperSize);
  }

  Future<void> setBluetoothAddress(String? address){
    return splashServiceInterface.setBluetoothAddress(address);
  }

  String? getBluetoothAddress (){
    return splashServiceInterface.getBluetoothAddress();
  }
