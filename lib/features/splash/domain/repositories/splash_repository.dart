...
class SplashRepository implements SplashRepositoryInterface {
  ...
  Future<void> setPaperSize(int? paperSize) async {
    if(paperSize != null) {
      await sharedPreferences.setString(AppConstants.savedPaperSize, jsonEncode(paperSize));
    }else {
      await sharedPreferences.remove(AppConstants.savedPaperSize);
    }
  }
  ...
  int? getPaperSize() {
    int? paperSize;
    if(sharedPreferences.containsKey(AppConstants.savedPaperSize)) {
      paperSize = jsonDecode(sharedPreferences.getString(AppConstants.savedPaperSize)!);
    }
    return paperSize;
  }
