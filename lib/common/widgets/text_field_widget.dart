    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      Container(
        ...
        child: TextField(
          ...
          onChanged: widget.isAmount ? (value) {
            ...
            if (newValue != value) {
              final selection = widget.controller?.selection ?? TextSelection.collapsed(offset: newValue.length);
              int newOffset = selection.baseOffset;

              // Adjust cursor position if a comma was replaced
              if (value.contains(',') && selection.baseOffset > 0) {
                newOffset = selection.baseOffset;
              }

              widget.controller?.value = widget.controller!.value.copyWith(
                text: newValue,
                selection: TextSelection.collapsed(offset: newOffset > newValue.length ? newValue.length : newOffset),
              );
            }
          ...
          } : widget.onChanged as void Function(String)?,
