...
class AppConstants {
  static const String appName = 'Goind Negocios';
  ...
  static const String baseUrl = 'https://admin.goind.es';
  // static const String baseUrl = 'https://6am.one/mart/juan-version-update/test';
  ...
  static const String savedPaperSize = 'paper_size';
